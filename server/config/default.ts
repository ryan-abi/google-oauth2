export default {
  ...
  origin2: "http://localhost:3050",
  dbUri:
    "mongodb+srv://georges:aaa1@cluster0.7ykoiu6.mongodb.net/?retryWrites=true&w=majority",
  saltWorkFactor: 10,
  accessTokenTtl: "15m",
  refreshTokenTtl: "1y",
...
-----END RSA PRIVATE KEY-----`,
  googleClientId: "fill",
  googleClientSecret: "fill",
  googleOAuthRedirectUrl: "fill",
};
